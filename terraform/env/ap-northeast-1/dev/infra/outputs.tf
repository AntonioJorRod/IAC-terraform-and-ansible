...
output "eks_cluster_endpoint_west" {
  description = "Endpoint del cluster EKS en ap-northeast-1"
  value       = module.eks_west.cluster_endpoint
}

output "eks_cluster_ca_west" {
  description = "CA del cluster EKS en ap-northeast-1"
  value       = module.eks_west.cluster_certificate_authority
}

output "cluster_name_west" {
  description = "Nombre del cluster EKS en ap-northeast-1"
...
output "cluster_certificate_west" {
  description = "Autoridad de certificados del cluster EKS en ap-northeast-1"
  value       = module.eks_west.cluster_certificate_authority
}

output "aws_auth_ready_west" {
  description = "Recurso nulo que indica que el aws-auth ConfigMap está aplicado en ap-northeast-1"
  value       = module.eks_west.aws_auth_ready
}

# --- ALB ---
output "alb_dns_name_west" {
  description = "DNS del Application Load Balancer en ap-northeast-1"
  value       = module.alb_west.dns_name
}

output "alb_arn_west" {
  description = "ARN del Application Load Balancer en ap-northeast-1"
  value       = module.alb_west.arn
}

# --- Ansible Core ---
output "ansible_core_id_west" {
  description = "ID de la instancia Ansible Core en ap-northeast-1"
